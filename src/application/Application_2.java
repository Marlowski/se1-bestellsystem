...
public final class Application_2 {
    public static void main(String[] args) {
        ...
        Order o1234 = dataFactory.createOrder(cTimo);
        o1234.addItem(dataFactory.createOrderItem(aKaffeemaschine.getDescription(),aKaffeemaschine,1)
        ).addItem(dataFactory.createOrderItem(aTasse.getDescription(),aTasse,6)
        );

        Order o1235 = dataFactory.createOrder(cSandra);
        o1235.addItem(dataFactory.createOrderItem(aTeekocher.getDescription(),aTeekocher,1));
        o1235.addItem(dataFactory.createOrderItem(aBecher.getDescription(),aBecher, 4));
        o1235.addItem(dataFactory.createOrderItem(aTeller.getDescription(),aTeller, 4));

        List<Order> orders = new ArrayList<Order>( List.of( o5234, o8592, o3563, o6135, o1234, o1235) );
